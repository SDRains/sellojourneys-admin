...
const navigation = [
    ...
    { name: 'Location Management', href: '/locationmanagement', current: false },
]
...
export default function NavbarComponent({activeTab}: navbarProps) {
    return (
        <Disclosure
            as="nav"
                        ...
                        <Menu as="div" className="relative ml-3">
                            ...
                            >
                                ...
                                <MenuItem>
                                    <a
                                        href="#"
                                        className="block px-4 py-2 text-sm text-red-600 data-focus:bg-gray-100 data-focus:outline-hidden dark:text-red-400 dark:data-focus:bg-white/5"
                                    >
                                        Sign out
                                    </a>
                                </MenuItem>
